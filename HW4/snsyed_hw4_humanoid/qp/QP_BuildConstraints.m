...
% Reformulate the friction cone constraints into matrix form
Aineq_new = zeros(2, 12); % Initialize a zero matrix with 2 rows and 12 columns
Aineq_new(1, 11) = 1;    % Corresponds to GRFx
Aineq_new(1, 12) = -mu;  % Corresponds to -mu*GRFy
Aineq_new(2, 11) = -1;   % Corresponds to -GRFx
Aineq_new(2, 12) = -mu;  % Corresponds to -mu*GRFy

bineq_new = [0; 0];      % Initialize bineq

% Append the new constraints to existing ones
QP.Aineq = [QP.Aineq; Aineq_new];
QP.bineq = [QP.bineq; bineq_new];    